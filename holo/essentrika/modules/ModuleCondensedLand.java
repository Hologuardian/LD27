...
public class ModuleCondensedLand implements IModule, IPowerReciever
{
	Image sprite;
	Image poweredSprite;
	int powerValue = 0;
	IGenerator powerSource;
	public ModuleCondensedLand() throws SlickException
	{
		sprite = new Image("res/CondensedLand.png");
		poweredSprite = new Image("res/CondensedLandPowered.png");
	}
	
	@Override
	public int getID() 
	{
		return ModuleCreator.moduleCondensedLandID;
	}
	...
	public int getUpgradeCost(IModule upgrade) 
	{
		...
		return id == ModuleCreator.moduleImprovedLandID ? -600 : 0;
	}
	...
	{
		return key == Input.KEY_S ? ModuleCreator.moduleImprovedLandID : -1;
	}

	@Override
	public int getKeyFromUpgradeID(int id)
	{
		return id == ModuleCreator.moduleImprovedLandID ? Input.KEY_S : -1;
	}
